...
> Complete step-by-step instructions to build and deploy your UI Kit
...
# Expected output:
# public/css/hubzz.css (~45KB)
# public/js/hubzz.js (~25KB)
...
ls -lh public/css/hubzz.min.css  # Should be ~12KB
ls -lh public/js/hubzz.min.js    # Should be ~6KB
```
...
# Edit src/css/components/buttons.css (for example)
